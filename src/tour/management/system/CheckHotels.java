...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel", "Mandarin Oriental hotel", "Four Seasons Hotel", "Radisson Blue Hotel", "Classio Hotel", "The Bay club Hotel", "Breeze Blow Hotel", "The Taj hotel", "Happy Morning Hotel", "Riverview Hotel"};
        try {
            for (int i = 0; i <= 8; i++) {
    ...
    CheckHotels() {
        ...
        for (int i = 0; i <= 9; i++) {
            ...
            jimage[i] = images[i].getImage().getScaledInstance(800, 600, Image.SCALE_DEFAULT);
