...
//        ImageIcon i2= new ImageIcon(i1);
        //Now i have to pick items from source dir so there is a class called ClassLoader to pick up the icon from the classloader there is a function called getSystemResource
        //The image is zommed now to fix it there is a class called image and create its object.
        Image i2 = i1.getImage().getScaledInstance(1200, 600, Image.SCALE_DEFAULT);
        //Image class object cannot directly placed into label so we have to create an image icon classs and the put i2 there then we have to place ImageIcon class object into the label.
